/*
  # Fix get_all_posts function migration

  1. Function Updates
    - Drop existing function to avoid return type conflicts
    - Create new get_all_posts function with proper return type
    - Grant necessary permissions

  2. Performance
    - Optimized query for fetching posts with user interaction data
    - Efficient joins and subqueries for likes and bookmarks
*/

-- Drop existing function to avoid return type conflicts
DROP FUNCTION IF EXISTS get_all_posts(uuid);

-- Create the get_all_posts function with proper return type
